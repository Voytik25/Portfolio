...
/* harmony import */ var _components_rating__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/rating */ "./src/js/components/rating.js");
/* harmony import */ var _components_rating__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_rating__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_calculator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/calculator */ "./src/js/components/calculator.js");
...
/* harmony import */ var _components_review__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/review */ "./src/js/components/review.js");
/* harmony import */ var _components_review__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_review__WEBPACK_IMPORTED_MODULE_6__);
...
const totalAmountOfCredit = document.getElementById('monthly-payment');

// Все range

const inputsRange = document.querySelectorAll('.loan__input-range');

// Кнопка с процентной ставкой

const counterInput = document.getElementById('counter__input');
...
for (let input of inputsRange) {
  input.addEventListener('input', () => {
    assignValue();
    canculation(totalCost.value, creditTerm.value, counterInput.value);
  });
}
...
const canculation = function () {
  let totalCost = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 300000;
  let creditTerm = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  let counterInput = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 12;
  let monthlyPayment; // Ежемесячный платеж
  let totalCost1 = totalCost; // Сумма кредита
  let interestRate = counterInput; // Процентаная ставка
  let numberOfMonths = creditTerm; // Срок кредита (месяц)

  monthlyPayment = totalCost1 * interestRate / numberOfMonths;
...
const names = document.querySelectorAll('.reviews__name');
for (let vales of names) console.log(vales);
const titles = document.querySelectorAll('.reviews__titles');
titles.textContent = names;
