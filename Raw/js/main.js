...
/* harmony import */ var _components_ellipsis__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/ellipsis */ "./src/js/components/ellipsis.js");
/* harmony import */ var _components_ellipsis__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_ellipsis__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_observe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/observe */ "./src/js/components/observe.js");
/* harmony import */ var _components_observe__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_observe__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_card__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/card */ "./src/js/components/card.js");
...
const e1 = document.querySelector(".services__btn-info1"),
  t1 = document.querySelector(".services__card1");
e1.addEventListener("click", () => {
  t1.classList.toggle("services__card--visible");
});
const e2 = document.querySelector(".services__btn-info2"),
  t2 = document.querySelector(".services__card2");
e2.addEventListener("click", () => {
  t2.classList.toggle("services__card--visible");
});
const e3 = document.querySelector(".services__btn-info3"),
  t3 = document.querySelector(".services__card3");
e3.addEventListener("click", () => {
  t3.classList.toggle("services__card--visible");
});
...
const observer1 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    if (entry.isIntersecting) {
      document.querySelectorAll('.nav__link_mob').forEach(link => {
        let id = link.getAttribute('href').replace('#', '');
        if (id === entry.target.id) {
          link.classList.add('nav__link--active');
        } else {
...
const swiperP = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.portfolio__swiper', {
  slidesPerView: 'auto',
  spaceBetween: 16,
  loop: true,
  autoplay: {
...
const swiperR = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__swiper', {
  slidesPerView: 'auto',
  spaceBetween: 20
});
const swiperBH = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.blog-hero__swiper', {
  slidesPerView: 1
});
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!function () {
  ...
  var b = {
    ...
    i = function (a, b) {
      var c = f();
      g(b, c), a[c] = a[c] || {}, a[c].element = b, a[c].innerHTML = b.innerHTML;
    },
    j = function (a, b) {
      return a ? a[h(b)] : null;
    },
  ...
  a.prototype = {
    ...
    create: function (a) {
      if (this.conf = a, this.lines = {
        ...
        if (e && !c) {
          ...
          var f = this;
          b = function (a) {
            window.innerWidth != d && (d = window.innerWidth, f._isScheduled || (f._isScheduled = !0, window.requestAnimationFrame(function () {
              f._isScheduled = !1, f.add(k(f.temp));
            })));
          };
        } else {
          c = c || 16;
          var g;
          b = function (a) {
            window.innerWidth != d && (d = window.innerWidth, clearTimeout(g), g = setTimeout(function () {
              this.add(k(this.temp));
            }.bind(this), c));
          };
        }
    ...
    addElement: function (a) {
      if (this.conf.responsive) {
        var b = j(this.temp, a);
        b ? a.innerHTML !== b.innerHTML && (a.innerHTML = b.innerHTML) : i(this.temp, a);
      }
  ...
  var m = function (b) {
   ...
   true && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return m;
		...
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)), self.Ellipsis = m;
}();
